...
- (id) smooth
{
    ...
    UIImage *defaultImage_= [self duplicate];
...
- (id) fleaEffect
{
    ...
    [filter setValue:inputImage forKey:kCIInputImageKey];
    [filter setValue:[NSNumber numberWithDouble:0.8] forKey:@"inputNoiseLevel"];
...
- (id) colorDepth : (CGFloat)depth
{
    ...
    [filter setValue:inputImage forKey:kCIInputImageKey];
    [filter setValue:[NSNumber numberWithDouble:depth] forKey:@"inputLevels"];
    CIImage *result = [filter valueForKey:kCIOutputImageKey];
    CGImageRef cgImage = [context_ createCGImage:result fromRect:[result extent]];
    UIImage *resultImage = [UIImage imageWithCGImage:cgImage];
    CGImageRelease(cgImage);
...
- (id) vignette
{
    ...
    [filter setValue:inputImage forKey:kCIInputImageKey];
    [filter setValue:[NSNumber numberWithDouble:90.0] forKey:@"inputRadius"];
    CIImage *result = [filter valueForKey:kCIOutputImageKey];
    CGImageRef cgImage = [context_ createCGImage:result fromRect:[result extent]];
    UIImage *resultImage = [UIImage imageWithCGImage:cgImage];
    CGImageRelease(cgImage);
...
- (id) falseColor
{
    ...
    [filter setValue:inputImage forKey:kCIInputImageKey];
    [filter setValue:[CIColor colorWithString:@"#fd0000"] forKey:@"inputColor0"];
    [filter setValue:[CIColor colorWithString:@"#bacb00"] forKey:@"inputColor1"];
    CIImage *result = [filter valueForKey:kCIOutputImageKey];
    CGImageRef cgImage = [context_ createCGImage:result fromRect:[result extent]];
    UIImage *resultImage = [UIImage imageWithCGImage:cgImage];
    CGImageRelease(cgImage);
...
- (id) meanRemoval
{
    ...
    [filter setValue:inputImage forKey:kCIInputImageKey];
    [filter setValue:[NSNumber numberWithDouble:9] forKey:@"inputWidth"];
    [filter setValue:[NSNumber numberWithDouble:60] forKey:@"inputAngle"];
    [filter setValue:[NSNumber numberWithDouble:.75] forKey:@"inputUCR"];
...
- (id) colorFilter
{
    ...
    [filter setValue:inputImage forKey:kCIInputImageKey];
    [filter setValue:[NSNumber numberWithDouble:30.0] forKey:@"inputCubeDimension"];
...
- (id) colorClamp
{
    ...
    [filter setValue:inputImage forKey:kCIInputImageKey];
    [filter setValue:[CIVector vectorWithX:0.2 Y:0.2 Z:0.2 W:0.2] forKey:@"inputMinComponents"];
    [filter setValue:[CIVector vectorWithX:0.6 Y:0.6 Z:0.6 W:0.6] forKey:@"inputMaxComponents"];
...
- (id) colorTemperatureandTint
{
    ...
    [filter setValue:inputImage forKey:kCIInputImageKey];
    [filter setValue:[CIVector vectorWithX:3500 Y:0] forKey:@"inputNeutral"];
    [filter setValue:[CIVector vectorWithX:5500 Y:0] forKey:@"inputTargetNeutral"];
...
- (id) engrave
{
    ...
    [filter setValue:inputImage forKey:kCIInputImageKey];
    [filter setValue:inputImage forKey:@"inputDisplacementImage"];
    [filter setValue:[NSNumber numberWithInt:35] forKey:@"inputScale"];
...
- (id) emboss
{
    ...
    [filter setValue:inputImage forKey:kCIInputImageKey];
    [filter setValue:inputImage forKey:@"inputTexture"];
    [filter setValue:[NSNumber numberWithInt:125] forKey:@"inputScale"];
    [filter setValue:[CIVector vectorWithX:125 Y:125] forKey:@"inputCenter"];
...
- (id) droste
{
    ...
    [filter setValue:inputImage forKey:kCIInputImageKey];
//    [filter setValue:[NSNumber numberWithInt:75] forKey:@"inputStrands"];
//    [filter setValue:[NSNumber numberWithInt:30] forKey:@"inputRotation"];
//    [filter setValue:[NSNumber numberWithInt:10] forKey:@"inputZoom"];
//    [filter setValue:[NSNumber numberWithDouble:.5] forKey:@"inputPeriodicity"];
//    [filter setValue:[CIVector vectorWithX:150 Y:150] forKey:@"inputInsetPoint0"];
//    [filter setValue:[CIVector vectorWithX:300 Y:300] forKey:@"inputInsetPoint1"];
...
- (id) hole
{
    ...
    [filter setValue:inputImage forKey:kCIInputImageKey];
    [filter setValue:[CIVector vectorWithX:75 Y:75] forKey:@"inputCenter"];
    [filter setValue:[NSNumber numberWithInt:75] forKey:@"inputRadius"];
...
- (id) toneCurve
{
    ...
    [filter setValue:[CIVector vectorWithX:.1 Y:.05] forKey:@"inputPoint0"];
    [filter setValue:[CIVector vectorWithX:.3 Y:.2] forKey:@"inputPoint1"];
    [filter setValue:[CIVector vectorWithX:.4 Y:.2] forKey:@"inputPoint2"];
    [filter setValue:[CIVector vectorWithX:.6 Y:.4] forKey:@"inputPoint3"];
    [filter setValue:[CIVector vectorWithX:.9 Y:.8] forKey:@"inputPoint4"];
    CIImage *result = [filter valueForKey:kCIOutputImageKey];
    CGImageRef cgImage = [context_ createCGImage:result fromRect:[result extent]];
    UIImage *resultImage = [UIImage imageWithCGImage:cgImage];
    CGImageRelease(cgImage);
...
- (id)hue
{
    ...
    [filter setValue:[NSNumber numberWithDouble:0.8] forKey:@"inputAngle"];
    //inputAngle
    [filter setValue:inputImage forKey:kCIInputImageKey];
...
- (id)applyHue:(CGFloat)hue alpha:(CGFloat)alpha
{
...
- (id)applyShading
{
    ...
    if ([color getRed:&r green:&g blue:&b alpha:&a])
         [[UIColor colorWithRed:MAX(r - 0.2, 0.0)
                               green:MAX(g - 0.2, 0.0)
                                blue:MAX(b - 0.2, 0.0)
                               alpha:a] set];
    return self;
...
- (id)maskWithString:(NSString *)string font:(UIFont *)font size:(CGSize)size
{
...
- (id)imageByCombiningImageWithTextBottom:(NSString *)text secondImage:(UIImage *)secondImage
{
    UIFont *font = [UIFont fontWithName:@"Helvetica-Bold" size:30];
    
    UIImage *result = [self duplicate];
    CGSize newImageSize = [self size];
    UIGraphicsBeginImageContextWithOptions(newImageSize, NO, [[UIScreen mainScreen] scale]);
    [result drawAtPoint:CGPointMake(0,0)];
    CGSize secondImageSize = secondImage.size;
    CGFloat height = 50;
    CGFloat width = secondImageSize.width/ (secondImageSize.height/50);
    ...
    UIGraphicsEndImageContext();
    [secondImage drawAtPoint:CGPointMake(20,result.size.height - 50)];
    ...
    [text drawAtPoint:CGPointMake(80,result.size.height - 45) withAttributes:attributes];
...
- (id)imageByCombiningImageWithTextTop:(NSString *)text secondImage:(UIImage *)secondImage
{
    ...
    CGSize secondImageSize = secondImage.size;
    CGFloat height = 30;
    CGFloat width = secondImageSize.width/ (secondImageSize.height/30);
    UIGraphicsBeginImageContext(CGSizeMake(width, height));
    [secondImage drawInRect:CGRectMake(0, 0, width, height)];
    ...
    secondImage = UIGraphicsGetImageFromCurrentImageContext();
    UIGraphicsEndImageContext();
    [secondImage drawAtPoint:CGPointMake(20,20)];
    NSMutableParagraphStyle *paragraphStyle = [[NSParagraphStyle defaultParagraphStyle] mutableCopy];
    /// Set line break mode
    paragraphStyle.lineBreakMode = NSLineBreakByTruncatingTail;
    /// Set text alignment
    ...
    NSDictionary *attributes = @{ NSFontAttributeName: font,
                                  NSParagraphStyleAttributeName: paragraphStyle };
    [text drawAtPoint:CGPointMake(80,30) withAttributes:attributes];
    result = UIGraphicsGetImageFromCurrentImageContext();
    UIGraphicsEndImageContext();
    return result;
}

- (id)imageByCombiningImagewithImageTop:(UIImage*)secondImage {
...
- (id)imageByCombiningImagewithImageBottom:(UIImage*)secondImage {
    ...
    secondImage = UIGraphicsGetImageFromCurrentImageContext();
    UIGraphicsEndImageContext();
    [secondImage drawAtPoint:CGPointMake(20,newImageSize.height - 50)];
    result = UIGraphicsGetImageFromCurrentImageContext();
    UIGraphicsEndImageContext();
    return result;
}

- (id)imageByCombiningWithTextBottom:(NSString *)text
{
    ...
    NSDictionary *attributes = @{ NSFontAttributeName: font,
                                  NSParagraphStyleAttributeName: paragraphStyle };
    [text drawAtPoint:CGPointMake(20,image.size.height - 50) withAttributes:attributes];
    UIImage *result = UIGraphicsGetImageFromCurrentImageContext();
    UIGraphicsEndImageContext();
    return result;
}

- (id)imageByCombiningWithTextTop:(NSString *)text
{
    UIImage *image = [self duplicate];
    UIFont *font = [UIFont boldSystemFontOfSize:22];
    UIGraphicsBeginImageContext(image.size);
    ...
    NSDictionary *attributes = @{ NSFontAttributeName: font,
                                  NSParagraphStyleAttributeName: paragraphStyle };
    [text drawAtPoint:CGPointMake(20, 20) withAttributes:attributes];
